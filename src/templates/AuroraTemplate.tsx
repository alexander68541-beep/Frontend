          ...
          <section className="au-sec">
            ...
            <div className="au-projects">
              {data.projects.map((pr) => (
                <a key={pr.id} className="au-card" href={pr.url ? ext(pr.url) : undefined} target={pr.url ? "_blank" : undefined} rel="noreferrer">
        ...
        {hasContact && (
          <section className="au-sec"><h2 className="au-h2">Contact</h2>
            ...
            <div className="au-links">
              ...
              {p?.website && <a className="au-link" href={ext(p.website)} target="_blank" rel="noreferrer">Website</a>}
              {p?.resume_url && <a className="au-link" href={ext(p.resume_url)} target="_blank" rel="noreferrer">Résumé ↗</a>}
            </div>
          </section>
        )}
